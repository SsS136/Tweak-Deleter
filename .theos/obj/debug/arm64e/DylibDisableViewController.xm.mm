#line 1 "DylibDisableViewController.xm"
...
255.0/255.0];
        ...
        extension = [self getFileList:@".dylib" num:1 place:@"/Library/MobileSubstrate/DynamicLibraries"];
        extension2 = [self getFileList:@".dylib" num:2 place:@"/Library/MobileSubstrate/DynamicLibraries"];
